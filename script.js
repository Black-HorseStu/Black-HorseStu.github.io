...
///////////////////////////////////////////////////////////////////////////////
// start play
Player.prototype.playSlow = function() {
  if ( this.state == 'playing' ) {
    return;
  }
  // do not play if page is hidden, start playing when page is visible
...
Player.prototype.tickSlow = function() {
  // do not tick if not playing
  if ( this.state != 'playing' ) {
    return;
  }
...
proto.playSlowPlayer = function() {
  this.player.playSlow();
};
...
var $imagesCarouselNextToSelected = jQuery('.carouselImage.nextToSelected').flickity({
  accessibility: false,
  autoPlay: false,
  pauseAutoPlayOnHover: false,
  cellAlign: 'center',
...
var $imagesCarouselNextToSelected2 = jQuery('.carouselImage.nextToSelected2').flickity({
  accessibility: false,
  autoPlay: false,
  pauseAutoPlayOnHover: false,
  cellAlign: 'center',
...
function resizeCells() {
  ...
  jQuery('.carouselOfImages .carouselImage').removeClass("nextToSelected");
  jQuery('.carouselOfImages .carouselImage').removeClass("nextToSelected2");
  jQuery('.carouselOfImages .carouselImage').eq($current - 1).addClass("nextToSelected");
  jQuery('.carouselOfImages .carouselImage').eq($current - 2).addClass("nextToSelected2");
  var $endCell;
  if ($current + 1 == $length) {
    $endCell = "0";
  } else {
  ...
  jQuery('.carouselOfImages .carouselImage').eq($endCell).addClass("nextToSelected");
  jQuery('.carouselOfImages .carouselImage').eq($endCell + 1).addClass("nextToSelected2");
}
resizeCells();
